    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="行程记录" prop="xingchengjilu">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.xingchengjilu" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.xingchengjilu" label="行程记录" prop="xingchengjilu">
                    <span v-html="ruleForm.xingchengjilu"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  created() {
	...
	this.ruleForm.fanhuishijian = this.getCurDateTime()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.dengjiriqi = true;
          ...
          if(o=='xingchengjilu'){
            this.ruleForm.xingchengjilu = obj[o];
	    this.ro.xingchengjilu = true;
            continue;
          }
        }
      }
      ...
      this.$http({
		...
		if(json.xingbie!=''&&json.xingbie){
          ...
          this.$message.error(data.msg);
            ...
            this.fengxiandiquOptions = "是,否".split(',')
            this.jiaotonggongjuOptions = "公交,地铁,出租车".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
	...
	this.ruleForm.xingchengjilu = this.ruleForm.xingchengjilu.replace(reg,'../../../djangol748x/upload');
        } else {
          this.$message.error(data.msg);
        }
      });

<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="检测地址" prop="jiancedizhi">
          <el-input v-model="ruleForm.jiancedizhi" 
              placeholder="检测地址" clearable  :readonly="ro.jiancedizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="检测地址" prop="jiancedizhi">
              <el-input v-model="ruleForm.jiancedizhi" 
                placeholder="检测地址" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.fabushijian = true;
          ...
          if(o=='jiancedizhi'){
            this.ruleForm.jiancedizhi = obj[o];
	    this.ro.jiancedizhi = true;
            continue;
          }
          if(o=='xiangqing'){
	...
	this.ruleForm.xiangqing = this.ruleForm.xiangqing.replace(reg,'../../../djangol748x/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
